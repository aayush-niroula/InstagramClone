...
function Post({ post }) {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`https://instagramclone-u8xy.onrender.com/api/v1/post/${post._id}/${action}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`https://instagramclone-u8xy.onrender.com/api/v1/post/${post?._id}/comment`, { text }, {
                headers: {
    ...
    const deletePostHandler = async () => {
        try {
            const res = await axios.delete(`https://instagramclone-u8xy.onrender.com/api/v1/post/delete/${post?._id}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const bookmarkHandler =async ()=>{
        try {
            const res = await axios.get(`https://instagramclone-u8xy.onrender.com/api/v1/post/${post?._id}/bookmark`,{withCredentials: true})
